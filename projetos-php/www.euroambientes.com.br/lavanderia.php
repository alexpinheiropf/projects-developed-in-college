    ...
    <?php include_once 'componentes/menu.php';?>
		<!-- Begin Container -->
			<div id="container" class="opacity">
				...
				<div id="showcase">
					...
					<div class="showcase-slide">
						...
						<div class="showcase-content">
							<img src="style/images/planejados/lavanderia/l3.jpg" alt=""
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/planejados/lavanderia/l4.jpg" alt=""
								width="900" height="500" />
						</div>
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/planejados/lavanderia/l5.jpg" alt=""
								width="900" height="500" />
						</div>
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/planejados/lavanderia/l6.jpg" alt=""
								width="900" height="500" />
						</div>
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/planejados/lavanderia/l7.jpg" alt=""
								width="900" height="500" />
						</div>
					</div>
				</div>
				...
				<blockquote>Quem não gosta de deixar a sua roupa limpa num lugar
					sofisticado e agradável, você tem tudo isso com a Euro Ambientes</blockquote>
				<br>
			</div>
