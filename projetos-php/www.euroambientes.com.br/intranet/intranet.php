...
<body>
	...
	<div id="wrapper">
		...
		<div id="container" class="opacity" >
			...
			<h1 align="center">Sejam bem vindos ao Intranet Euro Ambientes</h2>
			<br>
			<div class="clear"></div>
				<table >
					<tr>
						<td><a href="cliente_lista.php">Cadastrar Cliente</a> </td>
					</tr>
					<tr>
						<td><a href="validalogon.php?acao=logoff">Logoff</a></td>
					</tr>
				</table>
