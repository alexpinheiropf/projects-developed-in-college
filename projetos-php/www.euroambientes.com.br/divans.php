    ...
    <?php include_once 'componentes/menu.php';?>
		<!-- Begin Container -->
			<div id="container" class="opacity">
				...
				<div id="showcase">
					...
					<div class="showcase-slide">
						...
						<div class="showcase-content">
							<img src="style/images/linha_definida/divans/d1.jpg" alt=""
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/linha_definida/divans/d2.jpg" alt=""
								width="900" height="500" />
						</div>
					</div>
				</div>
				...
				<blockquote>Seu banheiro na Euro Ambientes se torna um espaço para
					relaxar alem de ser bonito e agradável, aproveitando cada espaço</blockquote>
				<br>
			</div>
