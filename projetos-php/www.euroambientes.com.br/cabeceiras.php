    ...
    <?php include_once 'componentes/menu.php';?>
		<!-- Begin Container -->
			<div id="container" class="opacity">
				...
				<div id="showcase">
					...
					<div class="showcase-slide">
						...
						<div class="showcase-content">
							<img src="style/images/linha_definida/cabeceiras/c1.jpg" alt=""
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/linha_definida/cabeceiras/c2.jpg" alt=""
								width="900" height="400" />
						</div>
				...
				<blockquote>Cabeceiras estofadas de vários estilos contrastando com seu perfil</blockquote>
				<br>
			</div>
