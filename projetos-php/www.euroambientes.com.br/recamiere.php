    ...
    <?php include_once 'componentes/menu.php';?>
		<!-- Begin Container -->
			<div id="container" class="opacity">
				...
				<div id="showcase">
					...
					<div class="showcase-slide">
						...
						<div class="showcase-content">
							<img src="style/images/linha_definida/recamiere/r1.jpg" alt=""
					...
					<div class="showcase-slide">
						<!-- Put the slide content in a div with the class .showcase-content. -->
						<div class="showcase-content">
							<img src="style/images/linha_definida/recamiere/r2.jpg" alt=""
								width="900" height="500" />
						</div>
				...
				<blockquote>Apesar de ser uma peça mais decorativa ajuda também no
					design do seu dormitório</blockquote>
				<br>
			</div>
