...
<head>
<title>Novo Maverick 2015</title>
<meta charset="UTF-8" />
...
<script type="text/javascript"
	src="../../w.sharethis.com/button/buttons.js"></script>
				...
				<div id="main-left" class="span8">
					...
					<article class="post">
						<h2 class="entry-title">
							<span class="the_title">Lancamento 2015 do novo maverick</span>
						</h2>

						<div class="entry-content">
							<p>
								<img width="774" height="320"
									src="images/dummy/maverick15.jpg"
									alt="photodune-2043745-college-student-s" />
							</p>
							<p>Ford Maverick , junto com o Chevrolet Opala ( que tambem tera'
								releitura ) formam os chamados '' muscle cars '' nacionais . Os
								dois carros deixaram muita saudades , e merecem voltar a vida .
								Por isso apresento o novo Maverick 2014 . Acompanhe !
								Acreditaria que o novo '' Maveco'' utilizaria a nova plataforma
								do Mustang de proxima geracao . O modelo seira bem menor que o
								Mustang , algo como 30 centimetros mais ou menos , o que
								tornaria mais agil e agradavel ao dirigir .</p>
							<div class="ratings" style="float: none; margin-bottom: 10px;">
								<input class="star" type="radio" name="home-top-rating-1"
									value="1" disabled="disabled" /> <input class="star"
									type="radio" name="home-top-rating-1" value="2"
									disabled="disabled" /> <input class="star" type="radio"
									name="home-top-rating-1" value="3" disabled="disabled"
									checked="checked" /> <input class="star" type="radio"
									name="home-top-rating-1" value="4" disabled="disabled" /> <input
									class="star" type="radio" name="home-top-rating-1" value="5"
									disabled="disabled" />
							</div>
